...
/***/ (function(__unused_webpack_module, exports, __nccwpck_require__) {
    ...
    const utils_1 = __nccwpck_require__(6173);
    /**
     * Commands
     *
     * Command Format:
    ...
    const command_1 = __nccwpck_require__(2594);
    const file_command_1 = __nccwpck_require__(4539);
    const utils_1 = __nccwpck_require__(6173);
    const os = __importStar(__nccwpck_require__(2037));
    const path = __importStar(__nccwpck_require__(1017));
    const oidc_utils_1 = __nccwpck_require__(1804);
    /**
    ...
    const http_client_1 = __nccwpck_require__(4461);
    const auth_1 = __nccwpck_require__(3515);
    const core_1 = __nccwpck_require__(3453);
    class OidcClient {
    ...
    const pm = __nccwpck_require__(3496);
    let tunnel;
    var HttpCodes;
    (function (HttpCodes) {
    ...
    class HttpClient {
        ...
        _getAgent(parsedUrl) {
            ...
            if (useProxy) {
                ...
                if (!tunnel) {
                    tunnel = __nccwpck_require__(2177);
                }
                const agentOptions = {
    ...
    const MessageParser = __nccwpck_require__(1496);
    const RelaxedBody = __nccwpck_require__(9807);
    const sign = __nccwpck_require__(5765);
    ...
    */
    ...
    const mimeFuncs = __nccwpck_require__(6869);
    const crypto = __nccwpck_require__(6113);
    ...
    const PassThrough = (__nccwpck_require__(2781).PassThrough);
    const Cookies = __nccwpck_require__(7596);
    ...
    const packageData = __nccwpck_require__(4129);
    const shared = __nccwpck_require__(7299);
    ...
    const MimeNode = __nccwpck_require__(9499);
    const mimeFuncs = __nccwpck_require__(6869);
    ...
    const shared = __nccwpck_require__(7299);
    const mimeTypes = __nccwpck_require__(6969);
    const MailComposer = __nccwpck_require__(4823);
    const DKIM = __nccwpck_require__(8065);
    const httpProxyClient = __nccwpck_require__(9520);
    const util = __nccwpck_require__(3837);
    const urllib = __nccwpck_require__(7310);
    const packageData = __nccwpck_require__(4129);
    const MailMessage = __nccwpck_require__(8392);
    ...
    const base64 = __nccwpck_require__(9831);
    const qp = __nccwpck_require__(7220);
    const mimeTypes = __nccwpck_require__(6969);
    ...
    const qp = __nccwpck_require__(7220);
    const base64 = __nccwpck_require__(9831);
    const addressparser = __nccwpck_require__(3318);
    const fetch = __nccwpck_require__(1996);
    const LastNewline = __nccwpck_require__(5247);
    
    const LeWindows = __nccwpck_require__(2795);
    const LeUnix = __nccwpck_require__(8963);
    ...
    const Mailer = __nccwpck_require__(7193);
    const shared = __nccwpck_require__(7299);
    const SMTPPool = __nccwpck_require__(188);
    const SMTPTransport = __nccwpck_require__(6764);
    const SendmailTransport = __nccwpck_require__(3812);
    const StreamTransport = __nccwpck_require__(5073);
    const JSONTransport = __nccwpck_require__(2796);
    const SESTransport = __nccwpck_require__(4450);
    const fetch = __nccwpck_require__(1996);
    const packageData = __nccwpck_require__(4129);
    ...
    const os = __nccwpck_require__(2037);
    const crypto = __nccwpck_require__(6113);
    const DataStream = __nccwpck_require__(3120);
    const PassThrough = (__nccwpck_require__(2781).PassThrough);
    const shared = __nccwpck_require__(7299);
    ...
    const EventEmitter = __nccwpck_require__(2361);
    const PoolResource = __nccwpck_require__(7492);
    const SMTPConnection = __nccwpck_require__(1750);
    const wellKnown = __nccwpck_require__(3068);
    const shared = __nccwpck_require__(7299);
    const packageData = __nccwpck_require__(4129);
    ...
    const SMTPConnection = __nccwpck_require__(1750);
    const assign = (__nccwpck_require__(7299).assign);
    const XOAuth2 = __nccwpck_require__(7671);
    const EventEmitter = __nccwpck_require__(2361);
    ...
    module.exports = __nccwpck_require__(5690);
